...
function buildSeoPayload(route) {
  ...
  var titles = {
    ...
    careers: "Door-to-Door Sales Jobs Hiring Now, $150K+ Top Reps | HFS",
  ...
  var descriptions = {
    ...
    contact: "Book a 30-minute call with a door-to-door sales agency that answers in one business day. Fiber, security, solar, and home-service field teams.",
